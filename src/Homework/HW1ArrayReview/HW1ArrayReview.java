...
public class HW1ArrayReview {
    ...
    public static double[] readCSVFile(String fileName) {
        //read and return an array of comma separated values from a given file.
        //Assume that the first line contains a single number giving the number of lines in the file.
        double[] output = {1, 2, 3};
        String[] tempArr;
        String csvFile = "C:/Users/Joseph/Desktop/test.csv";
    ...
    public static void main(String[] args) {
        ...
        double[] test = {1, 2, 3, 4, 5, 216, 1, 6, 7 ,2, 7, 1, 7, 8, 2};
        ...
        System.out.print("CSV read using the same array: ");
        print(readCSVFile("test.csv"));
    }
